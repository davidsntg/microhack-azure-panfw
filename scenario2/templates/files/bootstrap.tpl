          ...
          <ethernet>
            <entry name="ethernet1/1">
              <layer3>
                ...
                <ip>
                  <entry name="${interface-trust-01}"/>
                  <entry name="${interface-trust-02}"/>
                  <entry name="${interface-trust-failover}"/>
                </ip>
                <lldp>
                  <enable>no</enable>
                </lldp>
            ...
            <entry name="ethernet1/2">
              <layer3>
                ...
                <ip>
                  <entry name="${interface-untrust-01}"/>
                  <entry name="${interface-untrust-02}"/>
                </ip>
                <lldp>
                  <enable>no</enable>
                </lldp>
